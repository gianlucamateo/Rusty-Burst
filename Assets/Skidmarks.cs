// from http://www.scrapsgame.com/a-skidmark-effect-for-vehicles-in-unity3d/
...
public class Skidmarks : MonoBehaviour {
	...
	const float MARK_WIDTH = 0.20f; // Width of the skidmarks. Should match the width of the wheels
	const float GROUND_OFFSET = 0.02f;	// Distance above surface in metres
	const float MIN_DISTANCE = 0.2f; // Distance between points in metres. Bigger = more clunky, straight-line skidmarks
